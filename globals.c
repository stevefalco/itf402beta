...
byte_ptr		internal_io_buffer	= (byte_ptr)0 ;
byte_ptr		internal_io_ptr		= (byte_ptr)0 ;
word			int_io_buff_length	= 0 ;
word			current_font		= NORMAL_FONT ;
...
byte_ptr		saved_context		= (byte_ptr)0 ;
byte_ptr		global_ptr			= (byte_ptr)0 ;
byte_ptr		common_word_ptr		= (byte_ptr)0 ;
byte_ptr		prog_block_ptr		= (byte_ptr)0 ;
std_object_ptr	std_obj_list		= (std_object_ptr)0 ;
plus_object_ptr	plus_obj_list		= (plus_object_ptr)0 ;
word			resident_blocks		= 0 ;
word			save_blocks			= 0 ;
FILE			*debug_file			= (FILE *)0 ;
header			data_head ;
...
boolean			alternate_prompt	= FALSE ;
boolean			xfer				= FALSE ;
